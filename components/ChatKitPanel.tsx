...
import {
  ...
  WORKFLOW_ID,
  getThemeConfig,
  ORIA_FULL_CONFIG, // ✅ on importe la config complète
} from "@/lib/config";
...
export function ChatKitPanel({
  ...
  const chatkit = useChatKit({
    api: { getClientSecret },
    theme: getThemeConfig(theme), // ✅ respecte le type attendu
    ...ORIA_FULL_CONFIG, // ✅ ajoute la configuration complète sans casser le typage
